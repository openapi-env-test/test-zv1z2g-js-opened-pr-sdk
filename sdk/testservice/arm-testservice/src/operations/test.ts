...
export class Test {
   ...
   * Put test.
   * @param [options] The optional parameters
   * @returns Promise<Models.TestPutResponse>
   */
  put(options?: msRest.RequestOptionsBase): Promise<Models.TestPutResponse>;
  /**
   * @param callback The callback
   */
  put(callback: msRest.ServiceCallback<Models.TestPutResult>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  put(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.TestPutResult>): void;
  put(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.TestPutResult>, callback?: msRest.ServiceCallback<Models.TestPutResult>): Promise<Models.TestPutResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      putOperationSpec,
      callback) as Promise<Models.TestPutResponse>;
  }
}
...
const putOperationSpec: msRest.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.TestPutResult
    },
    default: {
      bodyMapper: Mappers.CloudError
    }
